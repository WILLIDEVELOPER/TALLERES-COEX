...
diametroRueda = float(input("Ingrese el diametro de la rueda "))
grosorRueda = float(input("Ingrese el grosor de la rueda en metros "))

if diametroRueda > 1.4 :
    print("La rueda es para un vehiculo grande.")
    if grosorRueda < 0.4 :
        print("El grosor para esta rueda es inferior al recomendado")
elif diametroRueda <= 1.4  and diametroRueda > 0.8 :
    print("La rueda es para un vehículo mediano")
    if grosorRueda < 0.25 :
        print("El grosor para esta rueda es inferior al recomendado")
else:
    print("La rueda es para un vehículo pequeño")